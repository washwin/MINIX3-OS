...
int fs_readwrite(void)
{
  ...
  if(immediate == 1) {
    if(rw_flag == READING) {
      printf("MINIX 210010060 210010026: READ FROM IMM FILE.\n");
      ...
      printf("MINIX 210010060 210010026: CONTENTS OF IMMFILE:\n");
      for(i = 0; i < f_size; ++i) {
        printf("%c", buffer[i]);
      }
      printf("MINIX 210010060 210010026: EOF IMM FILE\n");
      ...
      printf("MINIX 210010060 210010026: WRITE TO IMM FILE.\n");
      vir_bytes zone;
