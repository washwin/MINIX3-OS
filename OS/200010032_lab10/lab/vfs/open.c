...
#include "vmnt.h"
#include "path.h"
#define S_IFIMM	(0110000 & S_IFMT) //change
...
/* Common code from do_creat and do_open. */
  ...
  if (oflags & O_CREAT)
  {
    // omode = I_REGULAR | (omode & ALLPERMS & fp->fp_umask);  // commented the regular file type

	//--------------------------------------------------------------
	omode = I_IMMEDIATE | (omode & ALLPERMS & fp->fp_umask); // file type is set to immediate
	//--------------------------------------------------------------
